...
export class MessagesSocket {
    ...
    establishConnectionWithClientAndSendInformation() {
        this.io.on("connection", async (socket) => {
            ...
            const messagesOnSystem = await messagesDAO.getNormalized();
            // console.log(util.inspect(messagesOnSystem, false, 12, true));
            ...
            socket.on("addMessage", async (data) => {
                ...
                this.io.sockets.emit("savedMessages", await messagesDAO.getNormalized());
            });
